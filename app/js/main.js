  ...
  $('.filter-price__input').ionRangeSlider({
    ...
    $(function () {
      ...
      function initializeClock(endtime) {
        const clock = document.getElementsByClassName('promo__clock')[0];
